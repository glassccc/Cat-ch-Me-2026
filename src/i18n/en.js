export const en = {
  ...
  event: {
    ...
    catchDesc:
      "Scan the QR code on site and find hidden Koonyang within the time limit. If you catch them all, you will receive a <b>free churros or coffee</b> <span>(one participation per person)</span>",
